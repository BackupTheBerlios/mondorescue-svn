/* mondo-restore.h
 * $Id: mondo-restore.h,v 1.3 2004/06/21 20:20:37 hugo Exp $
 */
...
void find_pathname_of_executable_preferably_in_RESTORING(char *, char*, char*);
...
int iso_mode(struct s_bkpinfo *bkpinfo,
...
int restore_a_biggiefile_from_CD(struct s_bkpinfo *, long, struct s_node*, char*);
int restore_a_biggiefile_from_stream(struct s_bkpinfo*, char*, long , char*, long long, struct s_node*, int, char*);
int restore_a_tarball_from_CD(char *, long, struct s_node*);
int restore_a_tarball_from_stream(struct s_bkpinfo*, char *, long, struct s_node*, long long, char*, char*);
int restore_all_biggiefiles_from_CD(struct s_bkpinfo*, struct s_node*);
int restore_all_biggiefiles_from_stream(struct s_bkpinfo*, struct s_node*);
...
int restore_live_from_monitas_server(struct s_bkpinfo *, char*, char*, char*);
