/***************************************************************************
    ...
    cvsid                : $Id: mondoprep.h,v 1.4 2004/06/16 10:38:29 hugo Exp $
 ***************************************************************************/
...
int partition_device (FILE*,const char *, int, int, const char *, long long);
int partition_device_with_parted (FILE*,const char *, int, int, const char *, long long);
