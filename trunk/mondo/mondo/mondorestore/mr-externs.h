/*
 * $Id: mr-externs.h,v 1.3 2004/06/10 15:29:13 hugo Exp $
 *
...
extern int edit_mountlist(char* mountlist_fname, struct mountlist_itself*, struct raidlist_itself*);
...
extern int make_list_of_drives(struct mountlist_itself*, struct list_of_disks*);
...
extern int read_file_from_stream_to_file(struct s_bkpinfo*, char*, long long);
extern int read_file_from_stream_to_stream(struct s_bkpinfo*, FILE*, long long);
extern int read_file_from_stream_FULL(struct s_bkpinfo*, char*, FILE*, long long);
